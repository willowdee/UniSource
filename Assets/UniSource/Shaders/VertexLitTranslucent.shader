Shader "UniSource/VertexLitTranslucent" {
    Properties{
        ...
        SubShader{
            ...
            CGPROGRAM
                #pragma surface surf UniSource alphatest:_Cutoff
                #pragma target 3.0
                ...
                inline fixed4 LightingUniSource(SurfaceOutput s, fixed3 lightDir, fixed3 viewDir, fixed atten)
                {
